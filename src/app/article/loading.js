      ...
      <div className="container">
        ...
        <div style={{ textAlign: 'center', maxWidth: '800px', margin: '0 auto', marginBottom: 'var(--space-16)' }}>
          <div className="pill-wrap" style={{ marginBottom: 'var(--space-6)' }}>
            <div className="skeleton" style={{ width: '120px', height: '28px', borderRadius: '999px', margin: '0 auto' }}></div>
          </div>
          <div className="skeleton skeleton-text-lg" style={{ height: '48px', width: '80%', margin: '0 auto', marginBottom: 'var(--space-4)' }}></div>
          <div className="skeleton skeleton-text" style={{ height: '20px', width: '60%', margin: '0 auto' }}></div>
        </div>
          ...
          {[...Array(6)].map((_, i) => (
            <div key={i} className="glass skeleton-card" style={{ padding: 0 }}>
              ...
              <div style={{ padding: 'var(--space-6)' }}>
                ...
                <div className="skeleton skeleton-text-lg" style={{ width: '90%' }}></div>
