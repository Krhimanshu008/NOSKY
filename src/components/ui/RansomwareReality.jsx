...
export default function RansomwareReality() {
  return (
    <section className="section" id="problem-statement" style={{ position: 'relative', overflow: 'hidden', paddingBottom: 'var(--space-24)', zIndex: 5 }}>
      <style>{`
      ...
      <div className="container grid grid-2" style={{ gap: 'var(--space-16)', alignItems: 'flex-start' }}>
        ...
        <div className="info-cards-col" style={{ display: 'flex', flexDirection: 'column', gap: 'var(--space-6)' }}>
